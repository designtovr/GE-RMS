        	...
        	<div class="row">
                ...
                <div class="col-md-12 p-b-20">
                    <ul class="list-inline">
                        <li>
                            <button type="button" class="btn btn-primary btn-md float-right" ng-click="OpenCustomerModal(0);">
                                <i class="fa fa-plus"></i>&nbsp; Add Customer
                            </button>
                        </li>
                        <li>
                            <button type="button" class="btn btn-primary btn-md float-right box m-r-10"  ng-click="exportToExcelSave('#customertable' , 'CustomerMaster.xls')">
                ...
                <div class="col-md-12">
                    ...
                    <div grid-data grid-options="customergridOptions" grid-actions="gridActions">
                        <div class="overflow-auto">
                            <table class="table table-borderless table-data3" id="customertable" name="customertable">
                                <thead>
                                    <tr>
                                        <th>Actions</th>
