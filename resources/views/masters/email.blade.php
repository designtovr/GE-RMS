            	...
            	<div class="row">
                    ...
                    <div class="col-md-1">
                        <label class="switch switch-text switch-success switch-pill">
                          <input type="checkbox" class="switch-input" checked="true" name="sendMail" id="sendMail" ng-model="sendMailToggle" ng-change="MailToggle()" >
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button ng-if="!emailmodal.edit" type="submit" class="btn btn-primary btn-sm" ng="AddSiteForm.$invalid" ng-click="AddEmail();">
