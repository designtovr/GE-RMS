        		...
        		<div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="" method="post" class="form-horizontal" name="AddReceiptForm" id="AddReceiptForm" novalidate>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="ga_no" class=" form-control-label">GA No. <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <input 
                                        type="text" 
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="re_date" class=" form-control-label">Receipt Date <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <input 
                                        type="text" 
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="cu_name" class=" form-control-label">Customer Name/Manufacture Name <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <input 
                                        type="text" 
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="end_cusname" class=" form-control-label">End Customer <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <input
	                                     type="text" 
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="courier_name" class=" form-control-label">Courier Name <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <input 
                                        type="text" 
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="no_of_boxes" class=" form-control-label">No Of Boxes <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <input 
                                        type="text" 
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary btn-sm" ng-disabled="AddReceiptForm.$invalid">
