            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                	<form name="RMAForm5" id="RMAForm5" class="form-horizontal" novalidate>
                        <div class="row form-group">
                            <div class="col col-md-4">
                                <label for="copy_invoice_address" class=" form-control-label">Copy Delivery Address</label>
                            </div>
                            <div class="col-12 col-md-8">
                                <label class="au-checkbox">
                                    <input type="checkbox" ng-model="rmaformdata.copy_delivery_address_to_invoice_address" ng-change="ChangeInvoiceAddress();">
                        ...
                        <div class="row form-group">
                            <div class="col col-md-4">
                                <label for="invoice_customer_name" class=" form-control-label">Name <span class="mandatory">*</span></label>
                            </div>
                            <div class="col-12 col-md-8">
                                <input 
                                type="text" 
                                ...
                                ng-model="rmaformdata.invoice_info.name" 
                                placeholder="Name"
                                class="form-control"
                                ng-minlength="3" 
                                ng-maxlength="200"
                                ...
                                <div ng-show="RMAForm5.invoice_customer_name.$touched && RMAForm5.invoice_customer_name.$error">
                                    ...
                                    <span class="help-block"
                                     ng-show="RMAForm5.invoice_customer_name.$error.minlength">
                                        Minimum 3 Characters Required
                                    </span>
                                    <span class="help-block"
                                     ng-show="RMAForm5.invoice_customer_name.$error.maxlength">
                                        Maximum 200 Characters Allowed
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                rows="3" 
                                placeholder="Address..."
                                ng-model="rmaformdata.invoice_info.address" 
                                class="form-control"
                                ng-minlength="3" 
                                ng-maxlength="200"
                                required></textarea>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                ng-model="rmaformdata.invoice_info.contact_person" 
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                id="invoice_tel_no" 
                                name="invoice_tel_no"
                                ng-model="rmaformdata.invoice_info.tel_no" 
                                placeholder="Tel No" 
                                class="form-control"
                                ng-minlength="7" 
                                ng-maxlength="15"
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                id="invoice_email" 
                                name="invoice_email"
                                ng-model="rmaformdata.invoice_info.email"
                                placeholder="Email" 
                                class="form-control"
                                ng-pattern="/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/"
                                required>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                ng-maxlength="15"
                                required>
                                <div ng-show="RMAForm5.invoice_gst.$touched && RMAForm5.invoice_gst.$error">
                                    <span class="help-block"
                                     ng-show="RMAForm5.invoice_gst.$error.required">
                                        Please Enter GST
                                    </span>
                                    <span class="help-block"
                                     ng-show="RMAForm5.invoice_gst.$error.minlength">
                                        Should Not Be Less Than 15 Characters
                                    </span>
                                    <span class="help-block"
                                     ng-show="RMAForm5.invoice_gst.$error.maxlength">
            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                	<form name="RMAForm6" id="RMAForm6" class="form-horizontal" novalidate>
                        <div class="row form-group">
                            <div class="col col-md-4">
                                <label for="delivery_customer_name" class=" form-control-label">Name <span class="mandatory">*</span></label>
                            </div>
                            <div class="col-12 col-md-8">
                                <input 
                                type="text" 
                                ...
                                ng-model="rmaformdata.delivery_info.name" 
                                placeholder="Name"
                                class="form-control"
                                ng-minlength="3" 
                                ng-maxlength="200"
                                required>
                                <div ng-show="RMAForm6.delivery_customer_name.$touched && RMAForm6.delivery_customer_name.$error">
                                    <span class="help-block"
                                     ng-show="RMAForm6.delivery_customer_name.$error.required">
                                        Please Enter Name
                                    </span>
                                    <span class="help-block"
                                     ng-show="RMAForm6.delivery_customer_name.$error.minlength">
                                        Minimum 3 Characters Required
                                    </span>
                                    <span class="help-block"
                                     ng-show="RMAForm6.delivery_customer_name.$error.maxlength">
                                        Maximum 200 Characters Allowed
                                    </span>
                                </div>
                            </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-footer">
                    ...
                    <button ng-if="rmaformdata.rma_status != 3" class="btn btn-secondary btn-sm" ng-click="SaveRMAForm();">
