                                ...
                                <form action="" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input type="text" id="rma-ref-no" name="rma-ref-no"
                                                   placeholder="RMA Reference No..." class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input type="text" id="ga-no" name="ga-no" placeholder="GA No..."
                                                   class="form-control">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <input type="text" id="act-reference" name="act-reference"
                                                   placeholder="ACT Reference" class="form-control">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="card ">
                                                <div class="card-body card-block">
                                                    <div id="Duplicate">
                                                        <div class="row form-group ">
                                                            ...
                                                            <div class="col col-md-2 offset-md-1">
                                                                <label for="type-of-material"
                                                                       class=" form-control-label">Type
                                                                    of Material</label>
                                                            </div>
                                                            <div class="col-2 col-md-2">
                                                                <input type="text" id="type-of-material"
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-md-2">
                                                                <label for="model-no" class=" form-control-label">Model
                                                                    No</label>
                                                            </div>
                                                            <div class="col-2 col-md-2">
                                                                <input type="text" id="model-no" name="model-no"
                                                                       placeholder="Model No" class="form-control">
                                                                <span class="help-block">Please Enter Model Number</span>
                                                            </div>
                                                            {{-- </div>
                                                             <div class="row form-group ">--}}
                                                            <div class="col col-md-2 offset-md-1">
                                                                <label for="serial-no" class=" form-control-label">Serial
                                                                    Number</label>
                                                            </div>
                                                            <div class="col-2 col-md-2">
                                                    ...
                                                    <div class="row form-group col-lg-12"></div>
                                                </div>
                                                <div class="row form-group">
