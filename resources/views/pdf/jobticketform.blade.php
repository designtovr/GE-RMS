...
<div class="text-uppercase ftr">
	...
	<div class="table-responsive">
		<table class="table tableStyle table-bordered">
			...
			<tr>
				...
				<td style="font-size: 15px">{{$material['part_no']}}</td>
				<td style="font-size: 15px">{{$material['comment']}}</td>
				<td style="font-size: 15px">{{$material['quantity']}}</td>
				<td style="font-size: 15px">{{$material['value']}}</td>
			</tr>
			@endforeach
			</tbody>
		</table>
	...
	<div class="row" style="margin-top: 30px">
		...
		<div class="col-7 float-right">
			<h1 class="text-left border border-dark" style="font-size: 18px;color:#000000;height:250px;padding :10px">Remarks: <span class="text-nowrap" style="font-weight: normal">{{$remarks}}</span></h1>
		</div>
	</div>
</div>
<br>
<br>
<div class ="Footer ftr" style="margin-top:15px;">
	<div class="row ">
		<div class="col" style="padding: 0;">
