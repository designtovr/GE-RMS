...
class PVListingRepository
{
	...
	private function PVList($status_id)
	{
		$pv = PhysicalVerificationMaster::
				...
				->whereIn('pv_status.current_status_id', $status_id)->orderBy('physical_verification.id')->get();
		return $pv;
	}
